...
use mz_cloud_resources::crd::{
    ...
    materialize::v1alpha2::{Materialize, MaterializeRolloutStrategy, MaterializeStatus},
};
    ...
    async fn promote(
        ...
        self.update_status(
            ...
            MaterializeStatus {
                ...
                requested_rollout_hash: rollout_hash,
...
impl k8s_controller::Context for Context {
    ...
    async fn apply(
        ...
        // TODO compare status last applied Materialize CR spec hash
                    ...
                    &self
                        .update_status(
                            ...
                            MaterializeStatus {
                                ...
                                requested_rollout_hash: mz_spec_hash.clone(),
                                conditions: vec![Condition {
                                    type_: "UpToDate".into(),
                                    status: "Unknown".into(),
                                    last_transition_time: Time(Timestamp::now()),
                    ...
                    self.update_status(
                        ...
                        MaterializeStatus {
                            ...
                            last_completed_rollout_environmentd_image_ref: status
                                .last_completed_rollout_environmentd_image_ref,
                            resource_id: status.resource_id.clone(),
                            requested_rollout_hash: mz_spec_hash,
                            conditions: vec![Condition {
                                type_: "UpToDate".into(),
                                status: "True".into(),
                                last_transition_time: Time(Timestamp::now()),
